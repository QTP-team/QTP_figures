...
p_merge1 <- plot_grid(p_host_swap_kaks_CountGreaterThan1_Bacteroidota, p_host_swap_kaks_CountLessThan1_Bacteroidota, 
                      p_host_swap_pnps_Bacteroidota, p_host_swap_pnps_Bacillota,
                      align = "h", labels = c("D", "E", "F", "G"), nrow = 1)
p_merge2 <- plot_grid(p_host_swap_pnps_TA, p_host_swap_pnps_TS, p_host_swap_pnps_Yak,
                      labels = c("A", "B", "C"), nrow = 1)
p_merge3 <- plot_grid(p_merge2, p_merge1, nrow = 2)
ggsave(p_merge3, filename = "Figure6-S2.pdf", height = 8, width = 10)