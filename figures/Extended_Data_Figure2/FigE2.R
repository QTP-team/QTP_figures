#Fig E2 The effective estimation of co-binned MAGs and SGBs using all the 79 Tibetan horse samples
library(tidyverse)
library(ggpubr)
library(reshape2)
library(UpSetR)
...
ggsave("1.result/figE2A.MAGs.pdf", plot.a, width = 6, height = 4)
...
ggsave("1.result/figE2B.QS50_per_Sample.pdf", plot.b, width = 6, height = 4)
...
ggsave("1.result/figE2C.SGBs.pdf", plot.c, width = 6, height = 4)
