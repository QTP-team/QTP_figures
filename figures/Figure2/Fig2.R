#Fig.2 Gut microbial diversity features of six animals host species
library(tidyverse)
library(ggpubr)
library(vegan)
library(ade4)
...
ggsave("1.result/fig2A.richness.pdf", richness.plot, width = 5.5, height = 3)
...
ggsave("1.result/fig2A.Shannon.pdf", Shannon.plot, width = 5.5, height = 4)
...
ggsave(plot = inner.p, "1.result/fig2B.inner_inter_bc.pdf", width = 5.5, height = 4)
...
ggsave("1.result/fig2C.host_pcoa.pdf", host.pcoa.p, width = 5.5, height = 4)
...
ggsave("1.result/fig2D.tree.pdf", p.hc.anno.done, width = 6, height = 10)
