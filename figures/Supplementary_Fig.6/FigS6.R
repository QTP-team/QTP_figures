#Fig.S6 taxonomic statistic of 14062 SGBs.
library(tidyverse)
library(readxl)
...
#taxon_comp("0.data/Tibetan.bac.count.tsv", "1.result/figS3A.Tibetan_bac_taxa.pdf", 5)
#taxon_comp("0.data/Tibetan.ar.count.tsv", "1.result/figS3B.Tibetan_ar_taxa.pdf", 3)
taxon_comp("0.data/Tibetan.bac.count.tsv", "1.result/figS6A.Tibetan_bac_taxa.none.legend.pdf", 5)
taxon_comp("0.data/Tibetan.ar.count.tsv", "1.result/figS6B.Tibetan_ar_taxa.none.legend.pdf", 3)
